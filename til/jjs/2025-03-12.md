...
<br>
<img src="./Image/KakaoTalk_20250313_093242150_01.jpg" width="70%">
<br>

  
- Position Embedding: 단어의 위치 정보를 학습하기 위한 임베딩.

<img src="./Image/KakaoTalk_20250313_093242150_02.jpg" width="70%">
<br>
...
<img src="./Image/KakaoTalk_20250313_093242150_04.jpg" width="50%">
<br>
  <br>
...
<img src="./Image/KakaoTalk_20250313_093242150_05.jpg" width="60%">
<br>
  <br>
...
- 각 Layer마다 Masked Multi-Headed Self-Attention을 활용해 예측하는 단어의 앞 단어만 반영해서 예측한다.
 ...
 <img src="./Image/KakaoTalk_20250313_093242150_06.jpg" width="50%">
<br>
  <br>
...
- source 문장과 target 문장의 길이가 달라도 잘 반영된다.
 <img src="./Image/KakaoTalk_20250313_093242150_07.jpg" width="90%">
<br>
<br>
...
- 기계번역에서는 Pre-training 하지 않은 언어도 번역할 수 있도록 Randomly Initialized Encoder를 추가하는 방식 제시
 <img src="./Image/KakaoTalk_20250313_093242150_13.jpg" width="60%">
<br>
<br>
...
1. Token Masking: BERT처럼 임의의 token을 샘플링 하여 [MASK] 토큰으로 대체한 문장을 Encoder에 입력
 <img src="./Image/KakaoTalk_20250313_093242150_08.jpg" width="50%">
<br>
<br>

2. Token Deletion: 임의의 token을 원본 문장에서 삭제한 뒤에 Encoder에 입력
 <img src="./Image/KakaoTalk_20250313_093242150_09.jpg" width="50%">
<br>
<br>

3. Text Infilling: 연속된 0~N개의 token들을 마스킹 한 뒤 Encoder에 입력 (Token Masking의 확장판)
 <img src="./Image/KakaoTalk_20250313_093242150_10.jpg" width="50%">
<br>
<br>
 
4. Sentence Permutation: 문서를 마침표(.)을 기준으로 여러 문장들로 나누고, 임의의 순서로 섞은 뒤, Encoder에 입력.
 <img src="./Image/KakaoTalk_20250313_093242150_11.jpg" width="30%">
<br>
<br>

5. Document Rotation: 전체 문서에서 임의로 선택된 token이 시작 token이 되도록 회전한 문장을 Encoder에 입력
 <img src="./Image/KakaoTalk_20250313_093242150_12.jpg" width="50%">
<br>
<br>
...
- Token Deletion은 생성 Task(요약, 질의응답)에서 Masking, Infilling을 능가.
 <img src="./Image/KakaoTalk_20250313_093242150_14.jpg" width="60%">
<br>
<br>
...
- Document Rotation, Sentence Shuffling(Permutation)은 단독으로 사용했을 때 효과가 적음.
 <img src="./Image/KakaoTalk_20250313_093242150_15.jpg" width="60%">
<br>
<br>
...
- Dynamic masking은 전처리 단계에서 마스킹 작업을 하지 않고, 모델에 입력할 때마다 마스킹 작업을 수행하여 매 epoch마다 새로운 마스킹 패턴이 나오게 함. (K-fold Cross Validation과 유사)
 <img src="./Image/KakaoTalk_20250313_093242150_16.jpg" width="70%">
<br>
<br>
...
- 질의응답 같은 task에서 성능 향상
 <img src="./Image/KakaoTalk_20250313_093242150_17.jpg" width="70%">
<br>
<br>
...
- 추가적으로 span 내부의 토큰들을 구분하기 위해 [MASK] 토큰의 Position Embedding 부여
 <img src="./Image/KakaoTalk_20250313_093242150_18.jpg" width="70%">
<br>
<br>
...
- Span boundary token(x4, x9)의 임베딩 값을 사용하여 전체 masked span을 예측하기 때문에 학습 시 span 전체의 정보가 많이 포함됨
 <img src="./Image/KakaoTalk_20250313_093242150_19.jpg" width="70%">
<br>
<br>
...
- Discriminator가 모든 토큰에 대해 판별을 해야해서 모든 토큰에 대해 학습 가능. (토큰 전체에서 loss 계산)
 <img src="./Image/KakaoTalk_20250313_093242150_20.jpg" width="70%">
<br>
<br>
...
- 그 결과, 파라미터 수가 줄고 학습 속도 상승
 <img src="./Image/KakaoTalk_20250313_093242150_21.jpg" width="70%">
<br>
...
- 기존 BERT 대비 모델 사이즈를 40% 수준으로 줄이고, 97% 수준의 성능을 유지하며 60% 가량 빠른 학습 속도를 보임.
 <img src="./Image/KakaoTalk_20250313_093242150_22.jpg" width="80%">
<br>
<br>
<br>

 <img src="./Image/KakaoTalk_20250313_093242150_23.jpg" width="50%">
 <img src="./Image/KakaoTalk_20250313_093242150_24.jpg" width="50%">

 <img src="./Image/KakaoTalk_20250313_093242150_25.jpg" width="50%">
 <img src="./Image/KakaoTalk_20250313_093242150_26.jpg" width="50%">

 <img src="./Image/KakaoTalk_20250313_093242150_27.jpg" width="50%">
<br>
<br>

<br>

 <img src="./Image/스크린샷 2025-03-13 093702.png" width="70%">
<br>
 <img src="./Image/스크린샷 2025-03-13 093711.png" width="70%">
<br>
 <img src="./Image/스크린샷 2025-03-13 093744.png" width="70%">
<br>
